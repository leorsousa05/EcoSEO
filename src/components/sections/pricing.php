<?php
$title = $title ?? 'Planos e Preços';
$subtitle = $subtitle ?? 'Escolha o plano ideal para seu projeto';
$description = $description ?? 'Oferecemos opções flexíveis para atender às necessidades de empresas de todos os tamanhos.';
$plans = $plans ?? [
    [
        'name' => 'Starter',
        'price' => 'R$ 99',
