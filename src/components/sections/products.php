<?php
$productsConfig = require __DIR__ . '/../../config/products.php';
$products = $products ?? $productsConfig['products'];
$carouselConfig = $productsConfig['carousel_config'];
?>
...
document.addEventListener('DOMContentLoaded', function() {
    new Glide('.products-carousel', <?= json_encode($carouselConfig) ?>).mount();
});
</script>
